  ...
  return (
    ...
    <div class="box">
      <form  class="form" action="">
         ...
         <div id="boxes">
           <input type="number"  id="name" placeholder="Enter your contact number"/>
         </div>
         <div id="boxes">
         ...
         <div id="boxes">
           <input type="password"  id="name" placeholder="please re-enter the password"/>
         </div>
         <div>
